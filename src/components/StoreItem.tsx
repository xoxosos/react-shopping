/*
 * @Author: LinRenJie
 * @Date: 2023-01-14 20:17:27
 * @LastEditTime: 2023-01-15 12:25:56
 * @Description: 
 * @FilePath: /react/src/components/StoreItem.tsx
            ...
            <div className='mt-auto'>
                {quantity === 0 ? (
                    <Button className='w-100' onClick={() => increaseCartQuantity(id)}>
                        + Add To Cart
                    </Button>) : <div className='d-flex align-items-center flex-column'
                        style={{ gap: '.5rem' }}
                    >
